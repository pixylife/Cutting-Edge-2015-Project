 ...
 */
public class ViewAllAuthors extends javax.swing.JDialog {
  private DefaultTableModel dtm;

    /**
     * Creates new form ViewAllAuthors
     */
    public ViewAllAuthors(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
private void viewAll(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllAuthors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewAllAuthors dialog = new ViewAllAuthors(new javax.swing.JFrame(), true);
