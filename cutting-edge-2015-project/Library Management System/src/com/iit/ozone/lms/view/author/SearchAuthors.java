 ...
 */
public class SearchAuthors extends javax.swing.JDialog {
     ...
     */
    public SearchAuthors(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Search Authors");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchAuthors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SearchAuthors dialog = new SearchAuthors(new javax.swing.JFrame(), true);
