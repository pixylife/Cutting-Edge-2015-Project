 ...
 */
public class UpdateAuthor extends javax.swing.JDialog {
     ...
     */
    public UpdateAuthor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        comboLoad(cmbAuthor);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateAuthor dialog = new UpdateAuthor(new javax.swing.JFrame(), true);
