...
package com.iit.ozone.lms.view.category;

/**
 *
 * @author Sahan Thinusha
 */
public class SearchCategory extends javax.swing.JDialog {

    /**
     * Creates new form SearchCategory
     */
    public SearchCategory(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SearchCategory dialog = new SearchCategory(new javax.swing.JFrame(), true);
